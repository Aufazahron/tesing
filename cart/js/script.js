(function() {
  ...
  function displayProducts() {
    ...
    if (lsContent !== null) {
      for (let product of lsContent) {
        productMarkup += `
          <tr>
          <td><img class="" src="${product.image}" alt="${product.name}" width="120"></td>
          <td id="databarang">${product.name}</td>
  ...
  function ceklis(){
    document.getElementById("Infokus").checked = false;
    document.getElementById("Colokan").checked = false;
  ...
  function checkout() {
    ...
    const cartProducts = cartContent.querySelector(".databarang").innerHTML;
